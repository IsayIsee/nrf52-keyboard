...
const action_t actionmaps[][MATRIX_ROWS][MATRIX_COLS] = { 
	[0] = ACTIONMAP(
		...
		CAPS, A, S, D, F, G, H, J, K, L, SCLN, QUOT, P1, ENT,
		LSFT, Z, X, C, V, B, N, M, COMM, DOT, SLSH, P0, FN0,
	...
	[1] = ACTIONMAP(
		...
		TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, MUTE, VOLD, VOLU, TRNS, TRNS, UP,
	...
	[2] = ACTIONMAP(
		...
		TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, PGUP, PGDN, TRNS,
		TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, HOME, END, TRNS, TRNS,
		TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, MUTE, VOLD, VOLU, TRNS, TRNS, TRNS,
